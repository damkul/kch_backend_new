...
namespace kch_backend.Infrastructure.Services
{
    public class ReportService : IReportService
    {
        ...
        public Task<List<CustomerBillingDto>> GetCustomerBillingReportAsync()
        {
            throw new NotImplementedException();
        }

        public Task<List<PaymentSummaryDto>> GetDailyPaymentReportAsync(DateTime date)
        {
            throw new NotImplementedException();
        }

        public Task<List<EventSummaryDto>> GetEventSummariesAsync(DateTime? from, DateTime? to)
        {
            throw new NotImplementedException();
        }

        public Task<List<MonthlyPaymentDto>> GetMonthlyPaymentReportAsync(string yearMonth)
        {
            throw new NotImplementedException();
        }

        public Task<List<StockRequirementDto>> GetStockRequirementSummaryAsync(int? eventId)
        {
            throw new NotImplementedException();
        }

        public Task<List<VendorPaymentReportDto>> GetVendorPaymentReportAsync()
        {
            throw new NotImplementedException();
        }
    }
